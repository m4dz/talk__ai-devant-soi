...
## 1. Figer la trame (fait)

- [x] 1.1 Valider la trame avec le speaker (fils, arc, décisions).
- [x] 1.2 Consigner la trame figée dans `design.md` (source de vérité de l'intention).
