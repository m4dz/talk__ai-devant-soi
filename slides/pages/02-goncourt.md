...
<!-- Section 2 — LE PIVOT (3 beats).
     BEAT 1 — La peur et le contrat.
     ⚠ RIGUEUR : l'Académie n'a RIEN annoncé, RIEN interdit. On ne montre
     que des propos attribués et sourcés, et des clauses d'éditeurs. -->

« On n'est pas à l'abri de se faire piéger. »
...
<!-- La clause d'originalité renforcée. C'est LA phrase du talk. -->
...
<!-- BEAT 2 — La question. Seule sur sa slide. -->
...
.muted { color: var(--color-muted); font-size: var(--text-lg); }
</style>
